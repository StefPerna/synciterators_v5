...
object BedWrapper {
  ...
  extends LocusLike
  {
    ...
    override def toString = // simpler toString() for debugging
 ...
 */
    ...
    // . strand must not be clustered with + or with - strand.
    // We have to let all three types mix. Hence, strand should
