...
object Samples {
   ...
   */
    ...
    def slurpedTrack: BedEIterator = Sample.slurpedTrackOf(this)
   ...
   */
    ...
    def slurpedTrackOf(s: Sample): BedEIterator = s.bedFile.slurpedEIterator
   ...
   *
   *  Serialization use only Limsoon's format for representing
