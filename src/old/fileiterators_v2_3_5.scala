  ...
  */
   ...
   */
    ...
    EFile[A] = {
      ...
      EFile.sort[A](this)(ct =ct, cmp =cmp, capacity =capacity, onDisk =onDisk)
   ...
   */
    ...
    : EFile[A] = {
      ...
      Transient(it, settings)(ct).toEFile.serialized
    }
   ...
   */
    ...
    EFile[A] = efobj.isEmpty match {
      ...
      case false =>     // EFile is non-empty. Sort it.
        ...
        try { merge[A](groups :_*)(ct = ct, onDisk = alwaysOnDisk, cmp = cmp) }
