...
object GenomeAnnot {
  ...
  /** Merge overlapping loci from two sorted lists of loci.
   *
   *  @param loci1
   *  @param loci2 are the two sorted lists of loci.
   *  @return the merged list of loci.
   */

    def union(
      loci1: List[GenomeLocus], 
      loci2: List[GenomeLocus]
    ): List[GenomeLocus] = {

      val q1 = loci1.to(Queue)
      val q2 = loci2.to(Queue)
      val qm = Queue[GenomeLocus]()
      val qa = Queue[GenomeLocus]()
  ...
  /** Merge overlapping loci in a list of lists of loci.
   *
   *  @param loci is the list of lists of loci.
   *  @return the merged list of loci.
   */

    def unionAll(loci: List[List[GenomeLocus]]): List[GenomeLocus] = {
