...
object BedWrapper {
   ...
   */
    ...
    trait BedParser extends Parser[Bed] {
      ...
      private def headerGet(n: Int) = header.get(n) match {
        case Some(k) => k
      ...
      private def headerParse(e: String) = {
        ...
        val fields = 
          ...
          yield { 
            ...
            (n, if (m == -1) n.toString else entry(n).take(m))
          }
        header = Map(fields.toIndexedSeq :_*)
      }


      def parseRaw(e: String): Bed = parseUncustomized(e)
        ...
        def parseMisc(entry: Array[String]): Map[String, Any] = { 
          ...
          val fields = 
            ...
            yield { 
              ...
              val m = entry(n).indexWhere(_ == '=')
              val (m0, m1) = (m == -1) match {
                case true  => (headerGet(n), entry(n))
                case false => (entry(n).take(m), entry(n).drop(m + 1))
              }
   ...
   */
    ...
    def deserializerBedFile: Deserializer[Bed] = {
      val bedParser = new BasicBedParser
   ...
   *             "9" get renamed to their ENCODE name.
    ...
    private def optField(field: Any): Double = 
  ...
  */
  ...
  /** Deserializer for Bed file, customized for ENCODE Narrow Peak.
   *

    val deserializerEncodeNPBedFile: Deserializer[Bed] = {
      EFile.deserializerEFile(
        CustomizableBedParser(toEncodeNPBedFile _),
        (e: String) => !(e startsWith "track"))
    }
  *
  */
  ...
  */
   ...
   */
    ...
    BedFile = {
      ...
      onDiskEFile[Bed](filename, settings, nocheck)
  ...
  */
   ...
   *
    ...
    BedFile = {
      ...
      slurpedBedFile(raw, filename, settings)
  ...
  */
   ...
   */
    ...
    : BedFile = {
      ...
      EFile.merge[Bed](efobjs: _*)(
        ct = classTag(ClassTag(classOf[SimpleBedEntry])),
        onDisk = onDisk,
        cmp = cmp)
    }
