...
// the monotonicity conditions (iii) - (v) below. Let x and y
...
//
// (v) For all u<<v, and y: If isBefore(y,u) and ~canSee(y,u), then ~canSee(y,v)
//
    ...
    { //
      ...
      { //
        ...
        if (exclusiveCanSee) { 
          ...
          // elem of itB, in accordance to Monotonicity assumption (v).
        } 
