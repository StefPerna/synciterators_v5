...
object EncodeNP {
   ...
   */
    ...
    val deserializerEncodeNPBedFile: Deserializer[Bed] = {
      EFile.deserializerEFile(
        BedSerializers.CustomizableBedParser(toEncodeNPBedFile _),
   ...
   */
   ...
   //
   // Customize DB files for ENCODE Narrow Peak.
   //
    ...
    DB =  {
      ...
      new DB(SampleFile.onDiskSampleFile(samplelist, settings, nocheck))
   ...
   def altOnDiskEncodeNPDB
    ...
    DB = {
      ...
      DB.altOnDiskDB(path)(samplelist, settings)
