...
object GMQL {
  ...
  /** Rename the tracks of Samples in this DB.
   *
   *  @param nameOf is the renaming function.
   *  @return a copy of this DB with the tracks of its Samples renamed.
   */

    def tracksSaved(nameOf: Sample => String): DB = DB.saveTracks(this)(nameOf)
  ...
  */
  ...
  /** Rename the tracks of Samples in this DB.
   *
   * @param nameOf is a function to generate the new name of a Sample's track.
   * @return a copy of this DB with tracks of its Samples renamed.
   */

    def saveTracks
      (db: DB)
      (nameOf: Sample => String)
    : DB = {
